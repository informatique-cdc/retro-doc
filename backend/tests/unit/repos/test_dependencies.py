...
class TestGetVerifiedFile:
    """Resolve a file belonging to a repository the caller can reach."""
...
class TestGetVerifiedRepo:
    """Resolve a repository the caller is already linked to."""
